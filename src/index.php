...
foreach( $xml->children() as $child )
{
	switch( $child->getName() )
	{
		...
		case("website"):
			...
			// LOCAL CHANGE: optional label="..." attribute. Without it presskit()
			// prints the whole URL as the link text, which overflows the sidebar.
			define("COMPANY_WEBSITE_LABEL", isset($child->attributes()->label)
		...
		<div class="uk-container uk-container-center">
			<div class="uk-grid">
				<div id="navigation" class="uk-width-medium-1-4">
					...
					<a class="nav-header" href="https://'. parseLink(COMPANY_WEBSITE) .'">'. COMPANY_WEBSITE_LABEL .'</a>
...
echo '					<div class="uk-grid">
						<div class="uk-width-medium-2-6">
							...
							<p>
								...
								<a href="https://'. parseLink(COMPANY_WEBSITE) .'">'. COMPANY_WEBSITE_LABEL .'</a>
							</p>
							<p>
...
// LOCAL CHANGE: upstream typo. This read count( $awards > 0 ), which evaluates
// count(true) == 1 and is therefore always truthy, so the Awards heading rendered
// even with no awards. The game page (sheet.php) had it right.
if( count( $awards ) > 0 )
{
